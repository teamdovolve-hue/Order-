 ...
 * NOTHING above them changed — the text chat behaves exactly as before, and this file
 * STILL contains no fetch()/AI call (the Groq/Deepgram calls live in js/voice-assistant.js
 * → api/voice/*). Only the import line below gained `cartExtras`.
 *
